$("document").ready(function () {
    ...
    var getDados = function (widget, ficheiro) {
        ...
        var url = "http://192.168.0.17/dashboard/Actividade%207/Website/JSON/" + ficheiro + ".JSON",
    ...
    var GraficoArea = (function () {
        ...
        /// </summary>
        function GraficoArea(titulo) {
            // Construtor de Widget é chamado
            Widget.call(this, titulo)
            this.modoVisualizacao = "normal";
            this.widgetTipo = "Grafico Area";
        };
    ...
    var GraficoBarras = (function () {
        ...
        function GraficoBarras(titulo, widgetAltura, widgetLargura, widgetX, widgetY) {
            ...
            this.widgetTipo = "Grafico Barras";
        };
    ...
    var GraficoLinhas = (function () {
        ...
        function GraficoLinhas(titulo, widgetAltura, widgetLargura, widgetX, widgetY) {
            // Construtor de Widget é chamado
            Widget.call(this, titulo, widgetAltura, widgetLargura, widgetX, widgetY);
            this.widgetTipo = "Grafico Linhas";
        };
    ...
    var Datas = (function () {
        ...
        /// <summary>
        /// Método construtor para a classe Datas, chama o construtor do Widget 
        /// </summary>
        function Datas(titulo, widgetAltura, widgetLargura, widgetX, widgetY) {
            // Construtor de Widget é chamado
            Widget.call(this, titulo, widgetAltura, widgetLargura, widgetX, widgetY);

            // Define o tipo e o elemento do widget
            this.widgetTipo = "contexto";
            this.widgetElemento = "histograma";
        ...
        /// </summary>
        /// <param name="id"> Id do widget, utilizado para selecção do mesmo </param>
        Datas.prototype.ConstroiSVG = function () {
            var self = this;
        ...
        /// Método que impõe os eventos de limite de data aos "pickers"
        /// </summary>
        Datas.prototype.LimitaDatas = function () {
            var self = this;
        ...
        /// Acrescenta os diferentes filtros à "dropdown"
        /// </summary>
        Datas.prototype.InsereDados = function (id) {
            var self = this;
        ...
        /// Método que atualiza a tabela, p.ex a sua escala ou os dados
        /// </summary>
        Datas.prototype.Atualiza = function () {
            var self = this
        ...
        /// Encapsula todos os elementos necessários à construção dos Filtros
        /// </summary>
        Datas.prototype.ConstroiGrafico = function (id) {
            var self = this;
        ...
        /// </summary>
        Datas.prototype.GuardaDataInicial = function () {
            var self = this;
        ...
        /// Guarda a data Inicial dos "pickers" no próprio widget
        /// </summary>
        Datas.prototype.GuardaDataFinal = function () {
            var self = this;
        ...
        Datas.prototype.getDatas = function () {
            var self = this;
    ...
    var Grid = (function () {
        ...
        Grid.prototype.AdicionaWidget = function (tipoWidget, titulo, dados) {
            ...
            switch (tipoWidget) {
                case "area":
                    self.listaWidgets.push(new GraficoArea("widget" + idUnico, titulo));
                    break;
                case "barras":
                    self.listaWidgets.push(new GraficoBarras("widget" + idUnico, titulo));
                    break;
                case "linhas":
                    self.listaWidgets.push(new GraficoLinhas("widget" + idUnico, titulo));
                    break;
                case "gauge":
                    self.listaWidgets.push(new Gauge("widget" + idUnico, titulo));
                    break;
                case "kpi":
                    self.listaWidgets.push(new KPI("widget" + idUnico, titulo));
                    break;
                case "tabela":
                    self.listaWidgets.push(new Tabela("widget" + idUnico, titulo, dados));
                    break;
                case "pie":
                    self.listaWidgets.push(new PieChart("widget" + idUnico, titulo));
                    break;
                case "filtros":
                    self.listaWidgets.push(new Filtros("widget" + idUnico, titulo));
                    break;
                case "datas":
                    self.listaWidgets.push(new Datas("widget" + idUnico, titulo));
                    break;
            }
        ...
        Grid.prototype.EscondeWidget = function () {
            ...
            $(document).on("click", ".esconde-widget", function () {
                ...
                // Muda atributo escondido
                self.listaWidgets[index].escondido = true;
        ...
        /// <summary>
        /// Método para mostrar widget que está "escondido"
        /// </summary>
        ...
        Grid.prototype.GuardaInformacao = function () {
            ...
            self.listaWidgets.forEach(function (item, curIndex) {
                if (item.escondido === false) {

                    // Definição do elemento que contém a informação do widget
                    var $elemento = $("#" + item.el).parent();

                    item.largura = $("#" + item.el).width();
                    item.altura = $("#" + item.el).height();

                    // Atualização do widget e o Objecto que comunica com o servidor
                    item.objectoServidor.widgetLargura = item.widgetAltura = $elemento.attr("data-gs-height");
                    item.objectoServidor.widgetAltura = item.widgetLargura = $elemento.attr("data-gs-width");
                    item.objectoServidor.widgetX = item.widgetX = $elemento.attr("data-gs-x");
                    item.objectoServidor.widgetY = item.widgetY = $elemento.attr("data-gs-y");


                    // Resto de atualização do objecto que comunica com o servidor.
                    item.objectoServidor.escondido = item.escondido;
                    item.objectoServidor.mostraLegenda = item.mostraLegenda;
                    item.objectoServidor.mostraToolTip = item.mostraToolTip;
                    item.objectoServidor.id = item.id;
                    item.objectoServidor.el = item.el;
                    item.objectoServidor.widgetTipo = item.widgetTipo;
        ...
        /// </summary>
        /// <param name="widget"> Seleção jQuery do widget a ser removido </param>
