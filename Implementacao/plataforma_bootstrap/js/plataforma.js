$("document").ready(function () {
        ...
        Widget.prototype.RedesenhaGrafico = function (id) {
            ...
            if (self.dados.dados !== undefined && self.dados.dados.Widgets[0] !== undefined) {
                ...
                if (self.dados.dados.Widgets[0].Items.length != 0) {
                    ...
                    if (self.widgetElemento === "pieChart") {
                ...
                dadosEscolhidos.forEach(function (item, curIndex) {
                    ...
                    self.pontos.selectAll(".ponto" + curIndex)
                      ...
                      .enter().append("rect")
                        ...
                        .attr("x", function (d) { return self.transformaX(d.date) - larguraRect / 2; })
    ...
    var Gauge = (function () {
        ...
        Gauge.prototype.AtualizaObjectoServidor = function () {
            ...
            console.log(self.valorMaximo);
            console.log(self.valorMinimo);
            console.log(self.valorMeta);
    ...
    var PropertyGrid = (function(){
        ...
        PropertyGrid.setWidgets = function (listaWidgetsDados, listaWidgetsContexto) {
            ...
            console.log(self.listaWidgetsDados);
        ...
        PropertyGrid.Inicializa = function () {
            ...
            self.inicializaAparencia = {
                ...
                Fundo: { name: "Fundo:", group: "Aparencia", type: "color", options: { preferredFormat: "hex" }, description: modo, showHelp: false },
        ...
        PropertyGrid.AtualizaPropertyGrid = function () {
            ...
            } else if (self.propertyGridElemento === "kpi") {
    ...
    var Grid = (function () {
        ...
        var grid,
            ...
            widgetsGrafico = ["GraficoArea", "GraficoBarras", "GraficoLinhas", "pieChart"],
            widgetsLabel = [],
