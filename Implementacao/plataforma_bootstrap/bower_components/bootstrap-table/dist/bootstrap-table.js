...
!function ($) {
    ...
    BootstrapTable.LOCALES['pt-PT'] = BootstrapTable.LOCALES['pt-PT'] = {
        formatLoadingMessage: function () {
            return 'A carregar, espere por favor...';
        },
        formatRecordsPerPage: function (pageNumber) {
            return sprintf('%s resultados por página', pageNumber);
        },
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf('A mostrar %s até %s de %s linhas', pageFrom, pageTo, totalRows);
        },
        formatDetailPagination: function (totalRows) {
            return sprintf('A mostrar %s linhas', totalRows);
        },
        formatSearch: function () {
            return 'Pesquisar';
        },
